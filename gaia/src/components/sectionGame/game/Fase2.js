...
class Fase2 extends Scene {
    ...
    preload() {
        ...
        this.load.image('fundo', 'fundoExplicacao.png');
        ...
        this.load.spritesheet('personagem', 'personagem.png', { frameWidth: 106.5, frameHeight: 190 });
        // Carregando imagem da poeira
        this.load.image('poeira', 'poeira.png');
        // Carregando imagem da bomba
        this.load.image('bomba', 'bomba.png');
        // Carregando imagem de game over
        this.load.image('perdeu', 'perdeu.png');
        // Carregando imagem de vitória
        this.load.image('ganhou', 'ganhou.png');
    }
    ...
    create() {
        ...
        this.physics.add.overlap(this.personagem, this.moeda, () => {
            ...
            var posicaoMoeda_Y = Math.RND.between(50, 650);
        ...
        this.physics.add.overlap(this.personagem, this.maca, () => {
            ...
            var posicaoMaca_Y = Math.RND.between(50, 650);
        ...
        this.physics.add.overlap(this.personagem, this.bomba, () => {
            ...
            var posicaoBomba_Y = Math.RND.between(50, 650);
